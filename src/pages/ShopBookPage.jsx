...
const ShopBookPage = () => {
  ...
  const [currentImage, setCurrentImage] = useState(
    foundBook && foundBook.img ? foundBook.img : ""
  );
            ...
            <div className="bookpage-img">
              ...
              {foundBook.images && (
                <div className="thumbnails-container">
                  <div
                    className="bookpage-img-thumbnail"
                    onClick={() => handleThumbnailClick(foundBook.img)}
                  >
                  ...
                  {foundBook.images.img2 && (
                    <div
                      className="bookpage-img-thumbnail"
                      onClick={() =>
                        handleThumbnailClick(foundBook.images.img2)
                      }
                    >
                  ...
                  {foundBook.images.img3 && (
                    <div
                      className="bookpage-img-thumbnail"
                      onClick={() =>
                        handleThumbnailClick(foundBook.images.img3)
                      }
                    >
                  ...
                  {foundBook.images.img4 && (
                    <div
                      className="bookpage-img-thumbnail"
                      onClick={() =>
                        handleThumbnailClick(foundBook.images.img4)
                      }
                    >
              ...
              {foundBook && foundBook.condition !== "Подарки" && (
                <div className="bookpage-data">
                  ...
                  {detailsOpen && (
                    <div
                      className={`book-details-expanded ${
                        detailsOpen ? "open" : ""
                      }`}
                    >
