...
import useGiftsFilters from '../useGiftsFilters/useGiftsFilters';
            ...
            {open && (
                <div className='filter__popup' onClick={(e) => e.stopPropagation()}>
                    <div className='popup__frst__column'>
                        ...
                        {uniqueGiftsGategories.map((genre) => (
                            <li
                                key={genre} 
                                onClick={() =>
                                    onClickGenre(genre)} 
                                className={giftsCategory && giftsCategory.includes(genre) ? 'active' : ''}
                            >
                                <input 
                                    type="checkbox" 
                                    className='checkbox'
                                    checked={giftsCategory && giftsCategory.includes(genre)}
